...
public class SplashViewController implements Initializable {
	...
	public void onClicked(ActionEvent actionEvent)  throws IOException {
		...
		window.hide();
		if(manageScene == null){
			FXMLLoader fxmlLoader = new FXMLLoader(ManageSchoolInventoryJFXApp.class.getResource("manage-schoolInventory-view.fxml"));
			Parent root = (Parent)fxmlLoader.load();
			ManageSchoolInventoryController controller = fxmlLoader.getController();
			controller.setStage(stage);
			manageScene = new Scene(root, 700, 600);
